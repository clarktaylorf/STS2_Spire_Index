export default async function handler(req, res) {
  ...
  try {
    ...
    const CORRECTIONS={
      ...
      'Energy Surge':{cost:2,costUp:3,rarity:'Uncommon',desc:'ALL players gain Energy. Exhaust.',descUp:'ALL players gain 2 Energy. Exhaust.'},
